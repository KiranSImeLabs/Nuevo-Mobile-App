...
class ApiConstants {
  // Base URLs
  static const String baseUrl = 'https://nuevo-medical-be.simelabs.in/api/v1';//'https://nuevo-dev-be.simelabs.in/api/v1';
  //'https://nuevo-medical-be.simelabs.in/api/v1';//'https://untaut-arletha-noninfusible.ngrok-free.dev/api/v1';//'http://192.168.0.220:3000/api/v1';
